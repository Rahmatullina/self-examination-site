...
class RegionModel(models.Model):
    ...
    land_sale_id_rgmu = models.CharField(max_length=1000, default='111')
    land_sale_statement_amount = models.CharField(max_length=100, default='0')
    land_sale_link = models.CharField(max_length=1000, default='my_link')
    land_sale_has_advanced_appointment = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    land_sale_has_advanced_appointment_comment = models.TextField(default='', blank=True)
    land_sale_has_btn_get_service = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    land_sale_has_btn_get_service_comment = models.TextField(default='', blank=True)
    land_sale_has_reglament = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    land_sale_has_reglament_comment = models.TextField(default='', blank=True)
    land_sale_has_estimation_quality = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    land_sale_has_estimation_quality_comment = models.TextField(default='', blank=True)
    land_sale_connected_to_fgis_do = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    land_sale_connected_to_fgis_do_comment = models.TextField(default='', blank=True)
    land_sale_has_electronic_form_printing = models.CharField(max_length=20, choices=SERVICE_CHOICES,
                                                                     default='Да')
    land_sale_has_electronic_form_printing_comment = models.TextField(default='', blank=True)
    land_sale_has_edition_draft = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    land_sale_has_edition_draft_comment = models.TextField(default='', blank=True)
    land_sale_has_term_of_consideration = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    land_sale_has_term_of_consideration_comment = models.TextField(default='', blank=True)
    land_sale_has_notif_consider_result = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    land_sale_has_notif_consider_result_comment = models.TextField(default='', blank=True)
    land_sale_has_causes_of_failure = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    land_sale_has_causes_of_failure_comment = models.TextField(default='', blank=True)
    land_sale_has_sample_document = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    land_sale_has_sample_document_comment = models.TextField(default='', blank=True)
    land_sale_has_document_template = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    land_sale_has_document_template_comment = models.TextField(default='', blank=True)

    land_lease_id_rgmu = models.CharField(max_length=1000, default='111')
    land_lease_statement_amount = models.CharField(max_length=100, default='0')
    land_lease_link = models.CharField(max_length=1000, default='my_link')
    land_lease_has_advanced_appointment = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    land_lease_has_advanced_appointment_comment = models.TextField(default='', blank=True)
    land_lease_has_btn_get_service = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    land_lease_has_btn_get_service_comment = models.TextField(default='', blank=True)
    land_lease_has_reglament = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    land_lease_has_reglament_comment = models.TextField(default='', blank=True)
    land_lease_has_estimation_quality = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    land_lease_has_estimation_quality_comment = models.TextField(default='', blank=True)
    land_lease_connected_to_fgis_do = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    land_lease_connected_to_fgis_do_comment = models.TextField(default='', blank=True)
    land_lease_has_electronic_form_printing = models.CharField(max_length=20, choices=SERVICE_CHOICES,
                                                                     default='Да')
    land_lease_has_electronic_form_printing_comment = models.TextField(default='', blank=True)
    land_lease_has_edition_draft = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    land_lease_has_edition_draft_comment = models.TextField(default='', blank=True)
    land_lease_has_term_of_consideration = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    land_lease_has_term_of_consideration_comment = models.TextField(default='', blank=True)
    land_lease_has_notif_consider_result = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    land_lease_has_notif_consider_result_comment = models.TextField(default='', blank=True)
    land_lease_has_causes_of_failure = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    land_lease_has_causes_of_failure_comment = models.TextField(default='', blank=True)
    land_lease_has_sample_document = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    land_lease_has_sample_document_comment = models.TextField(default='', blank=True)
    land_lease_has_document_template = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    land_lease_has_document_template_comment = models.TextField(default='', blank=True)

    ownership_right_id_rgmu = models.CharField(max_length=1000, default='111')
    ownership_right_statement_amount = models.CharField(max_length=100, default='0')
    ownership_right_link = models.CharField(max_length=1000, default='my_link')
    ownership_right_has_advanced_appointment = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    ownership_right_has_advanced_appointment_comment = models.TextField(default='', blank=True)
    ownership_right_has_btn_get_service = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    ownership_right_has_btn_get_service_comment = models.TextField(default='', blank=True)
    ownership_right_has_reglament = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    ownership_right_has_reglament_comment = models.TextField(default='', blank=True)
    ownership_right_has_estimation_quality = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    ownership_right_has_estimation_quality_comment = models.TextField(default='', blank=True)
    ownership_right_connected_to_fgis_do = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    ownership_right_connected_to_fgis_do_comment = models.TextField(default='', blank=True)
    ownership_right_has_electronic_form_printing = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    ownership_right_has_electronic_form_printing_comment = models.TextField(default='', blank=True)
    ownership_right_has_edition_draft = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    ownership_right_has_edition_draft_comment = models.TextField(default='', blank=True)
    ownership_right_has_term_of_consideration = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    ownership_right_has_term_of_consideration_comment = models.TextField(default='', blank=True)
    ownership_right_has_notif_consider_result = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    ownership_right_has_notif_consider_result_comment = models.TextField(default='', blank=True)
    ownership_right_has_causes_of_failure = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    ownership_right_has_causes_of_failure_comment = models.TextField(default='', blank=True)
    ownership_right_has_sample_document = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    ownership_right_has_sample_document_comment = models.TextField(default='', blank=True)
    ownership_right_has_document_template = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    ownership_right_has_document_template_comment = models.TextField(default='', blank=True)

    municipal_property_lease_id_rgmu = models.CharField(max_length=1000, default='111')
    municipal_property_lease_statement_amount = models.CharField(max_length=100, default='0')
    municipal_property_lease_link = models.CharField(max_length=1000, default='my_link')
    municipal_property_lease_has_advanced_appointment = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    municipal_property_lease_has_advanced_appointment_comment = models.TextField(default='', blank=True)
    municipal_property_lease_has_btn_get_service = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    municipal_property_lease_has_btn_get_service_comment = models.TextField(default='', blank=True)
    municipal_property_lease_has_reglament = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    municipal_property_lease_has_reglament_comment = models.TextField(default='', blank=True)
    municipal_property_lease_has_estimation_quality = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    municipal_property_lease_has_estimation_quality_comment = models.TextField(default='', blank=True)
    municipal_property_lease_connected_to_fgis_do = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    municipal_property_lease_connected_to_fgis_do_comment = models.TextField(default='', blank=True)
    municipal_property_lease_has_electronic_form_printing = models.CharField(max_length=20, choices=SERVICE_CHOICES,
                                                                      default='Да')
    municipal_property_lease_has_electronic_form_printing_comment = models.TextField(default='', blank=True)
    municipal_property_lease_has_edition_draft = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    municipal_property_lease_has_edition_draft_comment = models.TextField(default='', blank=True)
    municipal_property_lease_has_term_of_consideration = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    municipal_property_lease_has_term_of_consideration_comment = models.TextField(default='', blank=True)
    municipal_property_lease_has_notif_consider_result = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    municipal_property_lease_has_notif_consider_result_comment = models.TextField(default='', blank=True)
    municipal_property_lease_has_causes_of_failure = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    municipal_property_lease_has_causes_of_failure_comment = models.TextField(default='', blank=True)
    municipal_property_lease_has_sample_document = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    municipal_property_lease_has_sample_document_comment = models.TextField(default='', blank=True)
    municipal_property_lease_has_document_template = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    municipal_property_lease_has_document_template_comment = models.TextField(default='', blank=True)

    free_land_provision_id_rgmu = models.CharField(max_length=1000, default='111')
    free_land_provision_statement_amount = models.CharField(max_length=100, default='0')
    free_land_provision_link = models.CharField(max_length=1000, default='my_link')
    free_land_provision_has_advanced_appointment = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    free_land_provision_has_advanced_appointment_comment = models.TextField(default='', blank=True)
    free_land_provision_has_btn_get_service = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    free_land_provision_has_btn_get_service_comment = models.TextField(default='', blank=True)
    free_land_provision_has_reglament = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    free_land_provision_has_reglament_comment = models.TextField(default='', blank=True)
    free_land_provision_has_estimation_quality = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    free_land_provision_has_estimation_quality_comment = models.TextField(default='', blank=True)
    free_land_provision_connected_to_fgis_do = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    free_land_provision_connected_to_fgis_do_comment = models.TextField(default='', blank=True)
    free_land_provision_has_electronic_form_printing = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    free_land_provision_has_electronic_form_printing_comment = models.TextField(default='', blank=True)
    free_land_provision_has_edition_draft = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    free_land_provision_has_edition_draft_comment = models.TextField(default='', blank=True)
    free_land_provision_has_term_of_consideration = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    free_land_provision_has_term_of_consideration_comment = models.TextField(default='', blank=True)
    free_land_provision_has_notif_consider_result = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    free_land_provision_has_notif_consider_result_comment = models.TextField(default='', blank=True)
    free_land_provision_has_causes_of_failure = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    free_land_provision_has_causes_of_failure_comment = models.TextField(default='', blank=True)
    free_land_provision_has_sample_document = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
    free_land_provision_has_sample_document_comment = models.TextField(default='', blank=True)
    free_land_provision_has_document_template = models.CharField(max_length=20, choices=SERVICE_CHOICES, default='Да')
